...
public class Options implements Serializable {
	...
	private String kachelDirMosaik = uh;
	private String infoFile = uh;
	...
	private Options() {
		...
		try {
			...
			kachelDirMosaik = p.getProperty("kachelDirMosaik", uh);
			infoFile = p.getProperty("infoFile", uh + "/info.txt");
			try {
				kachelSize = Integer.parseInt(p.getProperty("kachelSize",
						"" + 20));
				...
				antialiasing = Boolean.parseBoolean(p
						.getProperty("antialiasing"));
				copyMetadata = Boolean.parseBoolean(p
						.getProperty("copyMetadata"));
	...
	public void saveOptions() {
		try {
			...
			p.setProperty("kachelDirMosaik", "" + kachelDirMosaik);
			p.setProperty("infoFile", "" + infoFile);
			p.setProperty("kachelSize", "" + kachelSize);
	...
	public String getKachelDirMosaik() {
		return kachelDirMosaik;
	}

	public void setKachelDirMosaik(String kachelDirMosaik) {
		this.kachelDirMosaik = kachelDirMosaik;
		saveOptions();
	}
