...
public class TableGalerie {
		...
		Thread t = new Thread() {
			public void run() {
				...
				for (int i = 0; i < images.length; i++) {
					...
					elements.add(new Element(i, images[i], o.getHmax(), o
							.getVmax(), big));
					...
					sb.append("      <td><a href=\"medium/image" + i
							+ ".html\" title=\"" + titel
					...
					if (count == x || i == (max - 1)) {
						...
						sb.append("     <td colspan=\""
								+ o.getGallerieWidth()
								+ "\" style=\"width: 100%; background-color: rgb("
								+ o.getBackground_r() + ","
								+ o.getBackground_g() + ","
								+ o.getBackground_b()
								+ "); vertical-align: top;\">\n");
						if (lastPage > 1) {
							if (page == 1)
								...
								if (page == 2)
									sb.append("      <div class=\"next\"><a href=\"index.html\" class=\"next\">&lt;&lt;</a>&nbsp;|&nbsp;<a href=\"index"
											+ (page + 1)
											+ ".html\" class=\"next\">&gt;&gt;</a></div>\n");
								else
									sb.append("      <div class=\"next\"><a href=\"index"
											+ (page - 1)
						...
						try {
							...
							if ((i + 1) == max) {
								try {
									m.jOutputDoc.insertString(
											m.jOutputDoc.getLength(),
											m.mes.getString("Generator.40")
													+ ls, m.readyAtr);
									m.text.setCaretPosition(m.jOutputDoc
											.getLength());
									m.jOutputDoc.insertString(m.jOutputDoc
											.getLength(), ls + images.length
											+ m.mes.getString("Generator.44")
											+ o.getOutput_dir_gallerie()
											+ m.mes.getString("Generator.45")
											+ ls, m.readyAtr);
									m.text.setCaretPosition(m.jOutputDoc
											.getLength());
								} catch (Exception e) {
									System.out.println(m.mes
											.getString("Generator.40"));
								}
								break;
							}
						} catch (Exception e) {
	...
	private void createPreview(int t, File file, String m_name, String b_name,
		...
		sb.append("       <a href=\"../big/" + b_name + "\" title=\"" + titel
				+ "\"><img src=\"" + m_name + "\" alt=\"" + titel
				+ "\" /></a>\n");
		sb.append("      </td>\n");
	...
	private void createCSS() {
		...
		sb.append("  background-color: rgb(" + o.getBackground_r() + ","
				+ o.getBackground_g() + "," + o.getBackground_b() + "); \n");
		sb.append("  font-size: 12pt;  \n");
		sb.append("  color: rgb(" + o.getForeground_r() + ","
				+ o.getForeground_g() + "," + o.getForeground_b() + "); \n ");
		...
		sb.append("  background-color: rgb(" + o.getBackground_r() + ","
				+ o.getBackground_g() + "," + o.getBackground_b() + "); \n ");
		sb.append("  border: solid 2px rgb(" + o.getForeground_r() + ","
				+ o.getForeground_g() + "," + o.getForeground_b() + ");\n");
		sb.append("  padding: 0;\n");
