	...
	public FileTree(Main m, List l) {
		...
		addTreeSelectionListener(new TreeSelectionListener() {
			...
			public void valueChanged(TreeSelectionEvent arg0) {
				expandPath((DefaultMutableTreeNode) (arg0.getPath()
